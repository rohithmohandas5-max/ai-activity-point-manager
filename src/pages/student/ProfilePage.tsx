...
export function ProfilePage({
  ...
  const remaining =
    totalRemaining(student);

  const fullyComplete =
    isFullyComplete(student);
  ...
  return (
    <div>
      <PageHeader
        title="Profile"
        subtitle="Your account and activity summary"
        icon={
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="card p-6 lg:col-span-1">
          <div className="flex flex-col items-center text-center">
            ...
            >
              ...
              >
                {fullyComplete
                  ? 'You have met all activity point requirements'
        ...
        <div className="card p-6 lg:col-span-2">
          ...
          <p className="mt-0.5 text-sm text-slate-500">
            Your current standing toward activity point requirements
          </p>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {complete
                        ? 'Completed'
                        : `${remainingPoints} points required`}
                    </p>
                  </div>
                );
              },
