...
import { GraduationCap, Mail, Lock, ChevronDown, ArrowRight, ShieldCheck, Users, User } from 'lucide-react';
      ...
      <div className="relative hidden w-1/2 overflow-hidden bg-gradient-to-br from-blue-700 via-blue-800 to-blue-950 lg:flex">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="max-w-md">
            <h1 className="text-4xl font-bold leading-tight">AI Activity Point Manager</h1>
            <p className="mt-4 text-lg text-blue-100">
              Track, manage, and complete your activity points with intelligent recommendations powered by AI.
            </p>
          ...
          <p className="text-xs text-blue-200">University Activity Management System. Prototype Demo.</p>
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center p-6 lg:w-1/2">
        <div className="w-full max-w-md">
          <div className="mb-8 flex items-center gap-3 lg:hidden">
            ...
            <span className="text-lg font-bold text-slate-800">AI Activity Point Manager</span>
          </div>
          ...
          <div className="card p-8">
                      ...
                      {ROLES.map((r) => (
                        <button
                          ...
                          className={cn(
                            ...
                            role === r.value ? 'text-blue-700' : 'text-slate-700',
                          )}
                        >
                          <r.icon className="h-4 w-4" />
                          {r.label}
                          {role === r.value && <span className="ml-auto text-blue-600">{'\u2713'}</span>}
                        </button>
                      ))}
                    </div>
                  )}
            ...
            <p className="mt-6 text-center text-xs text-slate-400">
              Prototype only. No real authentication. Use any email and password.
            </p>
          </div>
        </div>
      </div>
